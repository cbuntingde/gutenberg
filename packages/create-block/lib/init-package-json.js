			...
			Object.entries( {
				...
				scripts: {
					...( wpScripts && {
						...
						/**
						 * Test command for block unit testing.
						 * Runs Jest unit tests for the block.
						 *
						 * @see https://developer.wordpress.org/block-editor/reference-guides/packages/packages-scripts/#jest
						 */
